...
type GetResourceByIDURL struct {
	ID string
...
func (o *GetResourceByIDURL) Build() (*url.URL, error) {
	...
	var _path = "/resource/{id}"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("ID is required on GetResourceByIDURL")
	}
...
func (o *GetResourceByIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetResourceByIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetResourceByIDURL")
	}
