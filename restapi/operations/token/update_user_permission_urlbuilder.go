...
func (o *UpdateUserPermissionURL) WithBasePath(bp string) *UpdateUserPermissionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateUserPermissionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateUserPermissionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateUserPermissionURL")
	}
