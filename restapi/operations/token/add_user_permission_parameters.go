...
// AddUserPermissionParams contains all the bound params for the add user permission operation
...
func (o *AddUserPermissionParams) bindAuthorization(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
